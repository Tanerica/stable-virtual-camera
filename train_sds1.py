...
def main(
    ...
    for epoch in range(num_train_epochs):
        ...
        for value_dict in dataloader:
            ...
            second_step = torch.randint(20, 980, (1,), device=device)
            second_step = denoiser.idx_to_sigma(second_step)
            ...
            for step_idx, sigma_step in enumerate(student_sigmas):
                ...
                teacher_sigma_val = torch.randint(20,999,(1,),device=device)
                teacher_sigma_val = denoiser.idx_to_sigma(teacher_sigma_val)
